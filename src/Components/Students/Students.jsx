  ...
  return (
    <section className="mx-auto">
      <div className="student">
        <div className="students h-max pb-10 lg:pb-[6vw]">
      ...
      <div className="flex flex-col mx-auto max-w-screen-xl px-2 mt-10 lg:mt-16 lg:px-0">
        <h2 className="text-navColor text-center my-5 text-4xl font-semibold md:text-5xl lg:text-6xl">How to Apply</h2>
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:flex lg:flex-row">
          <Application />
        </div>
        <a href="https://iaeste.smartsimple.ie/" className="bg-buttonColor w-max mx-auto text-white font-semibold py-2 px-5 rounded mt-10 md:mt-16">SIGN UP NOW</a>
      </div>

      <div className="internships mt-16">
        <div className="internship">
          <div className="py-10 px-2 mx-auto max-w-screen-xl lg:p-16">
            <h2 className="bg-buttonColor py-3 md:py-2 md:px-10 mx-auto rounded text-white font-semibold text-center text-3xl mb-5 md:mb-0 md:text-3xl md:w-max">
              Internships
            </h2>
